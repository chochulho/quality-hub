...
export const metadata: Metadata = {
  title: "p 관리도 — 부적합품률 계수치 관리도 무료 계산기",
  description:
    "p, np, c, u 계수치 관리도를 무료로 그려보세요. 불량률·불량 수·결점 수 데이터로 UCL/CL/LCL 자동 계산. Excel 내보내기.",
};

export default function PChartPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 md:py-14">
      ...
      <div className="mb-8">
        <p className="text-xs font-semibold text-brand-orange uppercase tracking-wider mb-2">계수치 관리도</p>
